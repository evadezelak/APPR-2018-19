...
Torej iz zgornjega zemljevida se nekako vidi delitev Evrope na zahodni in vzhodni del, kjer rdeča barva predstavlja države, ki imajo manj letalskega prometa, modra pa tiste, kjer je letalski promet bolj razširjen.
...
Za konec pa sem v aplikaciji Shiny pripravila še graf in zemljevid.

Na prvem grafu lahko opazujemo gibanje prihoda turistov preko letalskega prometa in prihoda vseh turistov v preučevanem obdobju, ob čemer lahko izbiramo, katero državo si želimo ogledati.
