...
3. **Izdratki za turizem** - podatki o višini izdatkov vsake države za turizem
  - `država` - spremenljivka: ime države (neurejen faktor),
  - `leto` - spremenljivka: vsebovana so leta med 1995 in 2017,
